...
#'
#' @param object  The mutation effects provided by "indelSNP" function.
...
#' plotMutProteins(object = covid_annot,proteinName = "NSP2", top = 20, outdir = NULL)
plotMutProteins <- function(object, proteinName = "NSP2", top = 20, outdir = NULL){
  oldpar <- par(no.readonly = TRUE)
  on.exit(par(oldpar))
  covid_annot_protein <- object[object$protein == proteinName,]
